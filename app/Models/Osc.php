...
{
    protected $fillable = [
        'nome_fantasia','cnpj','ano_fundacao','ano_inscricao_cnpj','sigla','cnae','responsavel_legal','banco_id',
        ...
        'visao_osc','finalidades_estatutarias_ods','link_estatuto_osc','user_id','logo'
    ];
