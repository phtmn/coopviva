      ...
      <div class="container pt-lg pb-100 ">
        ...
        <div class="col-lg-12">            
			 ...
			 <div class="row row-grid mt-4">
			   <div class="col-lg-6 text-center text-white font-weight-900">
			   <H3 class="text-white text-center font-weight-900 mt-5"> Título de Projeto
			   <br> 
			   ODSs
			   </h3>
			   	 </div>
				 <div class="col-lg-2 text-center text-white font-weight-900">
			   Status
			   	 </div>
				 <div class="col-lg-2 text-center text-white font-weight-900">
			   Meta R($)
				 ...
				 <div class="col-lg-2 text-center text-white font-weight-900">
			   <a href="" data-toggle="modal" data-target="#modal-default-projeto" class="btn btn-success btn-block">Saiba Mais</a> 
			   	 </div>
			 </div>
          </div>
        </div>
