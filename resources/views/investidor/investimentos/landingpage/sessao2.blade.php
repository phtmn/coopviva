...
<!--<section class="section section-lg bg-success"> -->
      <div class="container pt-lg pb-100 ">
        <div class="row text-center justify-content-center">
		 ...
		 <p class="lead text-white"> Aqui todas as instituições com seus respectivos projetos se inscrevem através de um cadastro completo e parametrizado conforme exigências de organismos internacionais de sustentabilidade. Isso significa que você pode facilmente capturar informaçõe.  </p>
        ...
        <div class="row row-grid mt-4">
          ...
          <div class="col-lg-6">
           <div>
            ...
            <p align="justify"  style="text-indent: 15px;"  class="font-weight-500 text-white mt-5">Aqui todas as instituições com seus respectivos projetos se inscrevem através de um cadastro completo e parametrizado conforme exigências de organismos internacionais de sustentabilidade. Isso significa que você pode facilmente capturar informaçõe.</p>
			 <hr color="white">
