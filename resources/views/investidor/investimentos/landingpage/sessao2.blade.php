        ...
        <div class="row row-grid mt-4">
          ...
          <div class="col-lg-6">
           <div>
            ...
            <p style="text-align:justify;"  style="text-indent: 15px;"  class="font-weight-500 text-white mt-5">{{$osc->missao ?? 'Aqui todas as instituições com seus respectivos projetos se inscrevem através de um cadastro completo e parametrizado conforme exigências de organismos internacionais de sustentabilidade.'}}</p>
			 <hr color="white">
