<p class="mt-0" align="justify"> Termos de uso e Política de Privacidade</br>

Bem-vindo ao COOPVIVA.com.br, serviço oferecido pela REDE DE CONEXÃO inscrita no CNPJ 22.506.780/0001-89.</br></br>
O acesso ao conteúdo daplataforma http://www.coopviva.com.br ("SITE") dependerá da sua plena concordância com o Termo de Uso e Política de Privacidade ("TERMO DE USO") aqui previstos, então a sua leitura e posterior aceitação são indispensáveis. 
...
O COOPVIVA também apoia outros canais de captação de recursos para projetos, através do compartilhamento de sua plataforma, cadastro de usuários e outras funcionalidades, com o que o usuário, desde já, concorda. 
...
SOBRE O CADASTRO:</br>
1. As OSC’s que tenham interesse em candidatar seu cadastro com seus respectivos projetos junto à plataforma, deverá efetuar seu pré cadastro, por meio de seu responsável legal, clicando no link“Cadastra-se” do SITE (www.coopviva.com.br) fornecendo as seguintes informações: </br></br>
1.	Como se chama;</br>
2.	 Como você deseja usar o COOPVIVA; </br>
3.	Estado;</br>
4.	Email;</br>
5.	Senha;</br>
6.	Confirmação da senha;</br>
7.	Aceitar este “Termo de Uso”</br></br>
2.	A OSC’s receberá um email automático para validação e liberação de seu acesso a plataforma.</br></br>
3.	Após sua validação a OSC deverá preencher os seguintes dados referente a instituição e seus projetos:</br>
3.1) Perfil do usuário:</br>
	3.1.1) Nome do contato da OSC;</br>
	3.1.2) Data de nascimento</br>
	3.1.3) Telefone</br>
	3.1.4) Gênero</br>
	3.1.5) CNPJ</br>
	3.1.6) Razão Social</br>
	3.1.7) Endereço (CEP, Logradouro, Número, Cidade, Estado e Complemento)</br></br>
3.2) OSC</br>
3.2.1) Perfil:</br>
		3.2.1.1) Dados gerais:</br>
3.2.1.1.1) Nome fantasia</br>
			3.2.1.1.2) Sigla OSC</br>
			3.2.1.1.3) Ano de fundação</br>
			3.2.1.1.4) Inscrição CNPJ</br>
			3.2.1.1.5) CNAE</br>
			3.2.1.1.6) Responsável Legal</br>
			3.2.1.1.7) Email</br>
			3.2.1.1.8) Telefone</br>
		3.2.1.2) Dados financeiros:</br>
			3.2.2.2.1) Conta para receber doação</br>
3.2.1.3) Endereço</br>
3.2.1.3.1) Cep</br>
3.2.1.3.2) Logradouro</br>
3.2.1.3.3) Número</br>
3.2.1.3.4) Cidade</br>
3.2.1.3.5) Estado</br>
3.2.1.3.6) Complemento</br>
3.2.1.3.7) Situação do imóvel</br>
3.2.1.4) Descrição</br>
		3.2.1.4.1) O que a OSC faz</br>
		3.2.1.4.2) Como surgiu a OSC</br>
		3.2.1.4.3) Missão da OSC</br>
		3.2.1.4.4) Visão da OSC</br>
		3.2.1.4.5) Link site</br>
		3.2.1.4.6) Link do Estatuto</br>
		3.2.1.4.7) Link da Finalidade Estatutária</br>
3.2.1.5) ODS (Nesta tela apareceram todas as ODS cadastradas no cadastro específico ODS no site) Veja instrução específica.</br>
3.2.1.6) Upload</br></br>
3.2.2) Projetos:</br>
3.2.2.1) Novo projeto</br>
3.2.2.1.1) Dados gerais</br>
		3.2.2.1.1.1) Nome do projeto</br>
		3.2.2.1.1.2) Valor</br>
		3.2.2.1.1.3) Registro 1</br>
		3.2.2.1.1.4) Instância</br>
		3.2.2.1.1.5) Âmbito</br>
		3.2.2.1.1.6) Segmento</br>
		3.2.2.1.1.7) Artigo de enquadramento</br>
3.2.2.1.2) Dados Financeiros</br>
		3.2.2.1.2.1) Conta para receber doações/patrocínio</br>
		3.2.2.1.2..2) Conta para receber patrocínios</br>
3.2.2.1.3) Responsável</br>
		3.2.2.1.3.1) Nome do proponente</br>
		3.2.2.1.3.2) CPF</br>
		3.2.2.1.3.3) CNPJ</br>
		3.2.2.1.3.4) Telefone 1</br>
3.2.2.1.3.5) Telefone 2</br>
3.2.2.1.3.6) Email principal</br>
3.2.2.1.3.7) Email secundário</br></br>
3.2.2.1.4) Resumo</br>
3.2.2.1.4.1) Objetivo Geral</br>
3.2.2.1.4.2) Objetivos específicos</br>
3.2.2.1.4.3) Justificativa</br>
3.2.2.1.4.4) Público Alvo</br>
3.2.2.1.4.5) Impactos esperados</br>
3.2.3) ODS – Selecionar os objetivos com suas respectivas metas que a OSC atende.</br></br>

4. Cada OSC poderá cadastrar mais de um projeto em seu cadastro. Todos os projetos cadastrados deverão ser de responsabilidade técnica, execução e financeira da OSC.</br></br>
...
OSC</br>
Conta criada por um representante reconhecido da Organização em questão do cadastro, podem ser ONG, OSCIP, Instituto, Empresa, Ministério, Associação, Organização.
...
INVESTIDOR</br>
Conta criada a fim de realizar contribuições financeiras para Organizações ou compartilhar informações através do COOPVIVA, podem ser Pessoas Física ou Pessoa Jurídica.
...
O COOPVIVA, através de sua detentora REDE DE CONEXÃO, cobra 5% (Cinco porcento) de comissão pelos serviços prestados de captação de recursos a OSC, conforme previsto neste “Termo de Uso” e previamente aceito pela OSC ao se cadastrar, sobre todos os investimentos realizados através da plataforma.
...
Cabe aoCOOPVIVA a responsabilidade de realizar a cobrança de todos comissionamentos e disponibilizar um painel administrativo online de acesso privado à OSC para controle e transparência de todas transações financeiras que forem intermediadas através do site para o recebimento de doações/patrocínios.
Todos os valores das doações/patrocínio cairão na conta da REDE DE CONEXÃO que fará as operações financeiras destinando os valores para cada conta corrente específica da OSC ou de seus projetos, garantindo desta forma a efetivação e validação do comprovante da transação financeira (DOC,TED,Deposito identificado, etc).
...
Caso ainda tenha alguma dúvida, a REDE DE CONEXÃO está a disposição para receber e responder seus comentários e perguntas através do canal de ajuda disponibilizado no site www.redeconexao.com.br. Você pode entrar em contato pelo e-mail: contato@redeconexao.com.br. Teremos um enorme prazer em lhe ajudar a esclarecer quaisquer dúvidas.</br>
</p>