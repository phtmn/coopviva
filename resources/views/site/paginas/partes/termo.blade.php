...
<div class="featured-cause">
 ...
 <center> <h3> Termos de uso e Política de Privacidade </h3></br> </center> 

<center><b> Bem-vindo ao COOPVIVA.com.br, serviço oferecido pela REDE DE CONEXÃO inscrita no CNPJ 22.506.780/0001-89.</br> </center></br>
...
<p align="justify" class="sample-text" style="text-indent: 15px;">O COOPVIVA, é uma plataforma online que proporciona a realização colaborativa destinada a financiar OSC’s (Organizações da Sociedade Civil) através de doações/patrocínio diretas e/ou através de seus respectivos projetos de sustentabilidade, tendo identificação direta com a Agenda 2030 da ONU. Uma maneira inovadora e prática de viabilizar a perenidade das OSC’s com a colaboração de diversas pessoas, possibilitando escalabilidade e engajamento de stakeholders.
...
<p align="justify" class="sample-text" style="text-indent: 15px;">O COOPVIVA também apoia outros canais de captação de recursos para projetos, através do compartilhamento de sua plataforma, cadastro de usuários e outras funcionalidades, com o que o usuário, desde já, concorda. 
...
SOBRE O CADASTRO:</br>
<p align="justify" class="sample-text" style="text-indent: 25px;"> 1. As OSC’s que tenham interesse em candidatar seu cadastro com seus respectivos projetos junto à plataforma, deverá efetuar seu pré cadastro, por meio de seu responsável legal, clicando no link“Cadastra-se” do SITE (www.coopviva.com.br) fornecendo as seguintes informações: </br>
<p align="justify" class="sample-text" style="text-indent: 35px;"> 1.	Como se chama;</br>
<p align="justify" class="sample-text" style="text-indent: 35px;"> 2.	 Como você deseja usar o COOPVIVA; </br>
<p align="justify" class="sample-text" style="text-indent: 35px;"> 3.	Estado;</br>
<p align="justify" class="sample-text" style="text-indent: 35px;"> 4.	Email;</br>
<p align="justify" class="sample-text" style="text-indent: 35px;"> 5.	Senha;</br>
<p align="justify" class="sample-text" style="text-indent: 35px;"> 6.	Confirmação da senha;</br>
<p align="justify" class="sample-text" style="text-indent: 35px;"> 7.	Aceitar este “Termo de Uso”</br>
<p align="justify" class="sample-text" style="text-indent: 25px;">2.	A OSC’s receberá um email automático para validação e liberação de seu acesso a plataforma.</br>
<p align="justify" class="sample-text" style="text-indent: 25px;">3.	Após sua validação a OSC deverá preencher os seguintes dados referente a instituição e seus projetos:</br>
<p align="justify" class="sample-text" style="text-indent: 35px;"> 3.1) Perfil do usuário:</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.1.1) Nome do contato da OSC;</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.1.2) Data de nascimento</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.1.3) Telefone</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.1.4) Gênero</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.1.5) CNPJ</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.1.6) Razão Social</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.1.7) Endereço (CEP, Logradouro, Número, Cidade, Estado e Complemento)</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2) OSC</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1) Perfil:</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.1) Dados gerais:</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.1.1) Nome fantasia</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.1.2) Sigla OSC</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.1.3) Ano de fundação</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.1.4) Inscrição CNPJ</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.1.5) CNAE</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.1.6) Responsável Legal</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.1.7) Email</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.1.8) Telefone</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.2) Dados financeiros:</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.2.1) Conta para receber doação</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.3) Endereço</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.3.1) Cep</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.3.2) Logradouro</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.3.3) Número</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.3.4) Cidade</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.3.5) Estado</br> 
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.3.6) Complemento</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.3.7) Situação do imóvel</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.4) Descrição</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.4.1) O que a OSC faz</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.4.2) Como surgiu a OSC</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.4.3) Missão da OSC</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.4.4) Visão da OSC</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.4.5) Link site</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.4.6) Link do Estatuto</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.4.7) Link da Finalidade Estatutária</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.5) ODS (Nesta tela apareceram todas as ODS cadastradas no cadastro específico ODS no site) Veja instrução específica.</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.1.6) Upload</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2) Projetos:</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1) Novo projeto</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.1) Dados gerais</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.1.1) Nome do projeto</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.1.2) Valor</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.1.3) Registro 1</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.1.4) Instância</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.1.5) Âmbito</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.1.6) Segmento</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.1.7) Artigo de enquadramento</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.2) Dados Financeiros</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.2.1) Conta para receber doações/patrocínio</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.2..2) Conta para receber patrocínios</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.3) Responsável</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.3.1) Nome do proponente</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.3.2) CPF</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.3.3) CNPJ</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.3.4) Telefone 1</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.3.5) Telefone 2</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.3.6) Email principal</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.3.7) Email secundário</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.4) Resumo</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.4.1) Objetivo Geral</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.4.2) Objetivos específicos</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.4.3) Justificativa</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.4.4) Público Alvo</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.2.1.4.5) Impactos esperados</br>
<p align="justify" class="sample-text" style="text-indent: 35px;">3.2.3) ODS – Selecionar os objetivos com suas respectivas metas que a OSC atende.</br>

<p align="justify" class="sample-text" style="text-indent: 25px;">4. Cada OSC poderá cadastrar mais de um projeto em seu cadastro. Todos os projetos cadastrados deverão ser de responsabilidade técnica, execução e financeira da OSC.</br> </br>
DEFINIÇÃO DOS USUÁRIOS</br>
<p align="justify" class="sample-text" style="text-indent: 15px;">USUÁRIO representa um grupo que contempla todos os papéis disponíveis a serem utilizados no COOPVIVA: OSC e INVESTIDORES</br></br>
OSC</br>
<p align="justify" class="sample-text" style="text-indent: 15px;">Conta criada por um representante reconhecido da Organização em questão do cadastro, podem ser ONG, OSCIP, Instituto, Empresa, Ministério, Associação, Organização.
...
INVESTIDOR</br>
<p align="justify" class="sample-text" style="text-indent: 15px;">Conta criada a fim de realizar contribuições financeiras para Organizações ou compartilhar informações através do COOPVIVA, podem ser Pessoas Física ou Pessoa Jurídica.
