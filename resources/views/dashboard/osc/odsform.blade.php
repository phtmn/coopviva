...
<div class="header bg-gradient-warning pb-8 pt-5 pt-md-8">
        ...
        <div class="container-fluid align-items-center">
                ...
                <div class="card shadow">
                    <div class="card-body bg-transparent">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " id="pills-remove-tab" data-toggle="pill" href="#pills-remove" role="tab" aria-controls="pills-remove" aria-selected="false"><p class="text-dark" >Remover</p></a>
                           </li> 
                        </ul>    
			...
			@if(isset($metas))
			   ...
			   <center> {!! Form::submit('Salvar',['class'=>'btn btn-outline-success']) !!} </center>
				{!! Form::close() !!}
			@endif
