                                        ...
                                        <table class="table stylish-table">
                                            ...
                                            <tbody>
                                             <!--   <tr>
                                                ...
                                                @else
                                                    <td> Pedro Henrique Tolentino de Melo Nogueira</td>
                                                    @endif   
                                                    <td>Ponto de Coleta</td>
                                                    <td>Projeto Mais Cultura</td>
                                                    <td> <i class="fa fa-file"></i><span> <a href=" "> </a></span></li>  </td>
                                                   <!-- <td>
                                                    
                                                    <h6>Ponto de Coleta</h6><small class="text-muted">Pedro Tolentino</small></td>
