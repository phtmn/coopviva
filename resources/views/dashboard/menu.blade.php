...
<div class="container" >
        <ul class="nav nav-tabs justify-content-center  ">
          <!--  <li class="nav-item"><a class="nav-link {{ $tab == 'dashboard' ? 'active' : ''}}" href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard " style="color:#8DDF6A;"></i> <b class="text-dark" >Dashboard</b></a></li> -->
            ...
            <li class="nav-item"><a class="nav-link {{ $tab == 'ods' ? 'active' : ''}}"  href="{{route('osc.objetivos')}}" > <i class="fa fa-institution" style="color:#8DDF6A;"></i> <b class="text-dark"> ODS</b></a></li>
