...
<div class="container  " >
        <ul class="nav nav-tabs justify-content-center  ">
            ...
            <li class="nav-item"><a class="nav-link {{ $tab == 'osc' ? 'active' : ''}}"  href="{{route('osc.create')}}"><i class="fa fa-institution" style="color:#8DDF6A;"></i><b class="text-dark"> Perfil da OSC</b> </a></li>
                ...
                <li class="nav-item"><a class="nav-link {{ $tab == 'lista-projetos' ? 'active' : ''}}"  href="{{route('projetos.index')}}"><i class="fa fa-suitcase " style="color:#8DDF6A;"></i><b class="text-dark"> Projeto</b></a></li>
